...
class SignUpTest {
    ...
    fun successfulRegistration(firstName: String, lastName: String, username: String, email: String, password: String, confirmPassword: String) {
        ...
        val homePage = signUpPage.fillForm(firstName, lastName, username, email, password, confirmPassword)
        Thread.sleep(1000)
